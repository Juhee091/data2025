...
@st.cache_resource
def load_model():
    model = DistilBertForSequenceClassification.from_pretrained("Juhee091/franchise-sentiment-model")
    tokenizer = DistilBertTokenizer.from_pretrained("Juhee091/franchise-sentiment-model")
